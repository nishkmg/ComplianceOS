      ...
      <DialogContent className="max-w-2xl p-8 overflow-hidden border border-border-subtle rounded-sm shadow-lg text-left">
        <DialogHeader className="mb-8">
          <div className="flex flex-col gap-2">
            <DialogTitle className="font-display-lg text-2xl text-danger font-bold">{title}</DialogTitle>
            <p className="font-ui-md text-sm text-mid leading-relaxed">{description}</p>
          </div>
        </DialogHeader>
        ...
        <div className="bg-section-muted border border-border-subtle p-6 mb-10 rounded-sm">
          ...
          <ul className="space-y-3 font-ui-sm text-[13px] text-dark-variant list-none p-0">
        ...
        <div className="mb-12">
          <label className="block font-ui-xs text-[10px] text-dark mb-2 uppercase tracking-widest font-bold">
        ...
        <DialogFooter className="flex flex-col-reverse sm:flex-row justify-end gap-4 border-t border-border-subtle pt-6">
          <button onClick={onClose} className="px-6 py-3 font-ui-sm text-sm text-mid hover:text-dark transition-colors border-none bg-transparent cursor-pointer">
            Cancel Operation
          </button>
          <button 
            onClick={onConfirm}
