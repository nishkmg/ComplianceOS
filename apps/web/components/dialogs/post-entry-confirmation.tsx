  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md p-0 overflow-hidden border border-border-subtle shadow-sm rounded-sm text-left">
        <DialogHeader className="flex flex-row items-center p-6 border-b-[0.5px] 200-border bg-section-muted gap-3">
        ...
        <div className="p-6 flex-grow">
          <p className="text-sm font-ui text-mid mb-6 leading-relaxed">
            Posting is irreversible and will update the general ledger. Ensure all amounts are correct.
          </p>
          
          <div className="bg-section-muted border 200-border rounded-sm p-5 space-y-4">
            <div className="flex justify-between items-center pb-3 border-b-[0.5px] 200-border border-dashed">
              <span className="text-ui-2xs font-bold text-mid uppercase tracking-widest">Entry Number</span>
              <span className="text-sm font-medium text-dark">{entry.entryNumber}</span>
            </div>
            <div className="flex justify-between items-center pb-3 border-b-[0.5px] 200-border border-dashed">
              <span className="text-ui-2xs font-bold text-mid uppercase tracking-widest">Posting Date</span>
          ...
          <div className="mt-4 flex items-start gap-2 text-ui-xs text-mid bg-section-muted/50 p-3 rounded-sm border 100-border italic">
            <Icon name="info" className="text-ui-lg text-light mt-0.5" />
