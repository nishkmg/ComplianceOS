      ...
      <DialogContent className="max-w-xl p-0 overflow-hidden border border-border-subtle shadow-2xl rounded-sm flex flex-col text-left">
        ...
        <div className="p-8 border-b-[0.5px] border-border-subtle flex items-start gap-4 bg-section-muted">
          ...
          <div className="text-left">
            <DialogTitle className="font-display-lg text-lg font-bold text-dark mb-2">Close Fiscal Year — {fiscalYear}</DialogTitle>
            <p className="font-ui-sm text-sm text-mid leading-relaxed">Closing a fiscal year is an <span className="font-bold text-dark italic underline decoration-red-600/30 decoration-2">irreversible action</span> that freezes all ledger entries for the period.</p>
          </div>
        </div>
        ...
        <div className="p-8 space-y-8 text-left bg-white">
          <div>
             ...
             <ul className="space-y-4 font-ui-sm text-[13px] text-dark-variant list-none p-0">
