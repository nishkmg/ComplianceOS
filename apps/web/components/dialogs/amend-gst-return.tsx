      ...
      <DialogContent className="max-w-2xl p-0 overflow-hidden border border-border-subtle shadow-lg rounded-sm flex flex-col">
        <DialogHeader className="px-6 py-4 border-b border-border-subtle flex flex-row items-center justify-between bg-section-muted">
          <div className="text-left">
            <DialogTitle className="font-display text-lg font-normal text-dark mb-1">Amend GST Return</DialogTitle>
        ...
        <DialogFooter className="px-6 py-4 border-t border-border-subtle bg-section-muted flex flex-row items-center justify-between rounded-b-sm">
          ...
          <button 
            ...
            className="bg-amber text-white px-8 py-3 font-ui text-xs font-bold uppercase tracking-widest rounded-sm hover:bg-amber-hover transition-all border-none shadow-sm cursor-pointer flex items-center gap-2"
          >
