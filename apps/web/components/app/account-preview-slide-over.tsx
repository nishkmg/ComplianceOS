...
// @ts-ignore
          ...
          <button className="flex-1 bg-amber text-white dark:text-amber-ink py-3 font-ui text-xs font-bold uppercase tracking-widest hover:bg-amber-hover transition-colors rounded-sm border-none cursor-pointer shadow-sm">
            New Journal
          </button>
        </footer>
      </aside>
