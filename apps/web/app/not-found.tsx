    ...
    <div className="bg-page-bg text-on-surface min-h-screen flex flex-col items-center justify-center font-ui antialiased p-6">
      <main className="w-full max-w-2xl mx-auto text-center flex flex-col items-center justify-center space-y-12">
        <div className="space-y-6">
          <Icon name="search_off" className="text-6xl text-light/50" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Link href="/dashboard" className="inline-flex items-center justify-center px-8 py-4 bg-amber text-white dark:text-amber-ink font-ui text-sm font-bold uppercase tracking-widest border border-amber transition-colors hover:bg-amber-hover no-underline shadow-sm">
            Return to Dashboard
          </Link>
        ...
        <div className="text-light font-mono text-ui-xs mt-4 uppercase tracking-widest">
