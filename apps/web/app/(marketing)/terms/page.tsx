    ...
    <div className="bg-page-bg text-on-surface antialiased min-h-screen">
      ...
      <main className="w-full max-w-[760px] mx-auto px-margin-mobile md:px-0 py-space-96">
        ...
        <header className="mb-space-64 text-left">
          ...
          <h1 className="font-marketing-hero text-marketing-hero text-on-surface mb-6">Terms of Service</h1>
          <p className="font-ui-lg text-ui-lg text-text-mid max-w-2xl leading-relaxed">Please read these Terms of Service carefully before using the ComplianceOS platform. These terms define your rights and obligations as an Indian accounting professional utilizing our infrastructure.</p>
        </header>

        {/* TOC */}
        <nav className="bg-white border-[0.5px] border-border-subtle p-8 mb-space-96 relative shadow-sm text-left">
          <div className="absolute top-0 left-0 w-full h-[2px] bg-primary-container"></div>
          <h2 className="font-mono-lg text-mono-lg mb-4 text-on-surface uppercase tracking-wide">Table of Contents</h2>
          <ul className="space-y-3 font-ui-md text-ui-md list-none p-0">
            {[
              ...
              <li key={item.href}>
                <a href={item.href} className="text-text-mid hover:text-primary-container hover:translate-x-1 transition-transform inline-block no-underline">
                  {item.label}
                </a>
              </li>
            ))}
        ...
        {/* Content */}
        <article className="space-y-space-64 font-ui-md text-ui-md text-on-surface-variant leading-relaxed text-left">
          <section className="scroll-mt-32" id="service-description">
            <h2 className="font-display-xl text-display-xl text-on-surface mb-6">1. Service Description &amp; Scope</h2>
            ...
            <div className="bg-section-muted p-6 border-l-2 border-primary-container mt-6">
              <p className="font-mono-md text-mono-md text-on-surface"><strong>Note:</strong> Service availability may be subject to maintenance windows, which are typically scheduled during non-peak hours (IST) to minimize disruption to filing deadlines.</p>
            </div>
          </section>

          <section className="scroll-mt-32" id="responsibilities">
            <h2 className="font-display-xl text-display-xl text-on-surface mb-6">2. User Responsibilities &amp; Data</h2>
          ...
          <section className="scroll-mt-32" id="liability">
            <h2 className="font-display-xl text-display-xl text-on-surface mb-6">3. Limitation of Liability</h2>
          ...
          <section className="scroll-mt-32" id="termination">
            <h2 className="font-display-xl text-display-xl text-on-surface mb-6">4. Term &amp; Termination</h2>
