      ...
      <main className="w-full max-w-[760px] mx-auto px-margin-mobile md:px-0 py-space-96">
        ...
        <nav className="bg-white border border-border-subtle p-8 mb-space-96 relative shadow-sm text-left">
          ...
          <ul className="space-y-3 font-ui text-ui-md list-none p-0">
            {[
              ...
              <li key={item.href}>
                <a href={item.href} className="text-secondary hover:text-amber hover:translate-x-1 transition-transform inline-block no-underline">
                  {item.label}
                </a>
              </li>
            ))}
        ...
        <article className="space-y-space-64 font-ui text-ui-md text-secondary leading-relaxed text-left">
            ...
            <ul className="list-none space-y-4 my-6 pl-4 border-l-[0.5px] border-border-subtle">
              {[
                ...
                <li key={item} className="relative pl-6">
                  <span className="absolute left-0 top-1 w-1.5 h-1.5 bg-amber rounded-full"></span>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <section className="scroll-mt-32" id="termination">
            <h2 className="font-display text-marketing-xl text-dark mb-6">4. Term &amp; Termination</h2>
