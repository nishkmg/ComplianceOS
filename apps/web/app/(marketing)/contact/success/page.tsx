  ...
  return (
    <div className="bg-page-bg text-dark min-h-screen">
      ...
      <main className="flex flex-col items-center justify-center py-32 px-8 text-center">
        ...
        <h1 className="font-display-xl text-display-xl text-dark mb-4">Message sent successfully.</h1>
        <p className="font-ui-md text-ui-md text-mid max-w-lg mx-auto leading-relaxed mb-12">Thank you for reaching out. Our team typically responds within 24 hours during business days.</p>
