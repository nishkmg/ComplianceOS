    ...
    <div className="bg-page-bg text-dark min-h-screen">
      ...
      <main className="min-h-screen">
        ...
        <header className="pt-space-128 pb-space-64 px-8 max-w-[1320px] mx-auto text-left">
          ...
          <h1 className="font-display-xl text-display-xl text-dark mt-4">Get in touch.</h1>
          <p className="font-ui-md text-ui-md text-mid max-w-xl mt-4">Whether you're a Chartered Accountant looking for automation or a business owner scaling in India, our team of experts is ready to assist.</p>
        </header>
        ...
        <section className="pb-space-128 px-8 max-w-[1320px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter-wide">
            {/* Left: Form */}
            <div className="lg:col-span-7 bg-white p-12 border border-border-subtle border-t-2 border-t-primary-container">
              {submitted ? (
                <div className="flex items-center gap-3 p-4 bg-surface-container-low border border-primary-container/20">
                  <Icon name="check_circle" className="text-primary" />
                  <span className="text-ui-sm font-ui-sm text-dark">Message sent successfully. We'll be in touch soon.</span>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col gap-2 text-left">
                      <label className="text-ui-xs font-ui-xs text-dark-variant uppercase">Full Name</label>
                    ...
                    <div className="flex flex-col gap-2 text-left">
                      <label className="text-ui-xs font-ui-xs text-dark-variant uppercase">Email Address</label>
                  ...
                  <div className="flex flex-col gap-2 text-left">
                    <label className="text-ui-xs font-ui-xs text-dark-variant uppercase">Business Type</label>
                  ...
                  <div className="flex flex-col gap-2 text-left">
                    <label className="text-ui-xs font-ui-xs text-dark-variant uppercase">Message</label>
            ...
            <div className="lg:col-span-5 space-y-gutter-wide">
              <div className="bg-section-muted border border-border-subtle p-8 text-left">
                ...
                <h3 className="font-ui-md font-bold text-dark mb-2">Email</h3>
                <p className="font-ui-sm text-mid">hello@complianceos.in</p>
              </div>
              <div className="bg-section-muted border border-border-subtle p-8 text-left">
                <Icon name="phone" className="text-primary text-2xl mb-4" />
                <h3 className="font-ui-md font-bold text-dark mb-2">Phone</h3>
                <p className="font-ui-sm text-mid">+91 95677 41714</p>
              </div>
              <div className="bg-section-muted border border-border-subtle p-8 text-left">
                <Icon name="location_on" className="text-primary text-2xl mb-4" />
                <h3 className="font-ui-md font-bold text-dark mb-2">Office</h3>
                <p className="font-ui-sm text-mid leading-relaxed">COM 07, First Floor, Vipul World, Sector 29, Gurgaon, Haryana 122001, India</p>
              </div>
            </div>
          </div>
        </section>
