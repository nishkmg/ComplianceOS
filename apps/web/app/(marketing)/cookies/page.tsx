      ...
      <main className="w-full min-h-screen pt-space-96 pb-space-128">
        <article className="max-w-[800px] mx-auto px-gutter-desktop">
          <header className="mb-space-64 text-center">
            ...
            <h1 className="font-marketing-xl text-marketing-xl text-dark mb-6">Cookie Policy</h1>
            <p className="font-ui-lg text-ui-lg text-mid max-w-2xl mx-auto">Last updated: October 15, 2024. This policy explains how ComplianceOS uses cookies and similar technologies to recognize you when you visit our website.</p>
          </header>

          <div className="space-y-space-48 border-t-[0.5px] border-border-subtle pt-space-48 text-left">
            {/* What are cookies */}
            <section>
              <h2 className="font-display-lg text-display-lg text-dark mb-6 flex items-center gap-3">
              ...
              <p className="font-ui-md text-ui-md text-mid leading-relaxed mt-4">
            ...
            <section>
              ...
              <p className="font-ui-md text-ui-md text-mid leading-relaxed mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-white border border-border-subtle p-8 border-t-2 border-t-primary-container">
                  <h3 className="font-ui-lg text-ui-lg text-dark mb-3">Essential Cookies</h3>
                  <p className="font-ui-sm text-ui-sm text-mid">These cookies are strictly necessary to provide you with services available through our Websites and to use some of its features, such as access to secure areas.</p>
                </div>
                <div className="bg-white border border-border-subtle p-8 border-t-2 border-t-primary-container">
                  <h3 className="font-ui-lg text-ui-lg text-dark mb-3">Performance Cookies</h3>
                  <p className="font-ui-sm text-ui-sm text-mid">These cookies are used to enhance the performance and functionality of our Websites but are non-essential to their use.</p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-section-amber border border-border-subtle p-10">
              <h2 className="font-display-lg text-display-lg text-dark mb-4">Contact Us</h2>
              <p className="font-ui-md text-ui-md text-mid mb-6">If you have any questions about our use of cookies or other technologies, please email us at privacy@complianceos.in.</p>
