...
const cards = [
  ...
  },
  {
    ...
    copy: 'GST-compliant invoices with GSTIN and HSN checks, gapless numbering, e-invoice IRN payloads and posting to the ledger the moment they are saved.',
  ...
  },
  {
    ...
    copy: 'PF, ESI, TDS and professional tax computed from salary structures each run, with payslips and challan data prepared from the same figures.',
  ...
  },
  {
    ...
    points: ['FIFO valuation', 'Stock operations', 'OCR capture'],
    image: '/images/marketing/receivables.png',
    alt: 'Receivables view in Arthvahi',
    href: '/features/inventory',
    linkLabel: 'Read the inventory module',
    span: 'lg:col-span-4',
  },
  {
    index: '07',
    label: 'E-invoice',
    title: 'IRN payloads built to the NIC schema',
    copy: 'E-invoice and e-way bill payloads prepared from the same invoices that feed GSTR-1, with production IRP connection on the roadmap.',
    points: ['IRN + signed QR', 'E-way bill payloads', 'NIC v1.03 schema'],
    image: '/images/marketing/gstr1.png',
    alt: 'Generated GSTR-1 with invoice lines in Arthvahi',
    href: '/features/e-invoice',
    linkLabel: 'Read the e-invoice module',
    span: 'lg:col-span-8',
  },
];
