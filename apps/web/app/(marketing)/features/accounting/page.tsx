      ...
      <main className="pt-32 pb-24">
        ...
        <section className="max-w-[1200px] mx-auto px-8 pt-16 pb-space-64">
          <div className="max-w-4xl text-left">
            ...
            <p className="font-ui-lg text-ui-lg text-mid max-w-2xl mb-10 leading-relaxed">
        ...
        <section className="max-w-[1200px] mx-auto px-8 py-space-64">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-space-48 items-center">
            <div className="text-left order-2 lg:order-1">
              ...
              <h2 className="font-display-xl text-display-xl text-dark mt-4 mb-6">Entries must balance before they post.</h2>
              <p className="font-ui-md text-ui-md text-mid leading-relaxed">Unlike spreadsheets, ComplianceOS prevents unbalanced journal entries at the UI level. You cannot post until debits equal credits — no exceptions, no manual checks.</p>
            </div>
            <div className="order-1 lg:order-2 bg-white border border-border-subtle p-8 shadow-sm">
              <div className="flex items-center justify-center gap-8 mb-4">
                <div><div className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold mb-1">Total Debit</div><div className="font-mono text-lg font-bold text-dark">₹ 25,000.00</div></div>
                <div><div className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold mb-1">Total Credit</div><div className="font-mono text-lg font-bold text-dark">₹ 25,000.00</div></div>
                <div><div className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold mb-1">Difference</div><div className="font-mono text-lg text-success font-bold">✓ ₹ 0.00</div></div>
              </div>
              <div className="bg-success-bg text-success text-center py-2 font-ui-xs text-[10px] uppercase font-bold tracking-widest">Voucher is balanced — Ready to Post</div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-section-muted py-space-64">
          <div className="max-w-[1200px] mx-auto px-8 text-left">
            <h2 className="font-display-xl text-display-xl text-dark mb-16 text-center">Three pillars of ledger-first accounting.</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={m.title} className="bg-white border border-border-subtle p-8 shadow-sm border-t-2 border-t-primary-container text-left">
                  <Icon name={m.icon} className="text-primary-container text-3xl mb-6 block" />
                  <h3 className="font-display-lg text-lg font-bold text-dark mb-4">{m.title}</h3>
                  <p className="font-ui-sm text-sm text-mid leading-relaxed">{m.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-space-96 px-8 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="font-marketing-xl text-marketing-xl text-dark mb-6">Start with the accounting module.</h2>
            <p className="font-ui-md text-ui-md text-mid mb-10">No modules to configure. No onboarding calls. The ledger is ready.</p>
