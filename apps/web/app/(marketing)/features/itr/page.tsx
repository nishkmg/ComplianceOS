      ...
      <main className="pt-32 pb-24">
        ...
        <section className="max-w-7xl mx-auto px-8 pt-16 pb-space-64 text-left">
          <div className="max-w-4xl">
            ...
            <Link href="/signup" className="bg-amber text-white px-8 py-4 font-ui text-sm font-bold uppercase tracking-widest hover:bg-amber-hover transition-colors no-underline rounded-sm shadow-sm inline-flex items-center gap-2">
