    ...
    <div className="bg-page-bg text-dark antialiased min-h-screen">
      ...
      <main className="pt-32 pb-24">
        ...
        <section className="max-w-[1200px] mx-auto px-8 pb-space-64">
          <h2 className="font-display-xl text-display-xl text-dark mb-12 text-left">ITR forms covered.</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={form.title} className={`bg-white border border-border-subtle p-8 shadow-sm relative text-left ${form.active ? 'border-t-2 border-t-primary-container' : ''}`}>
                <h3 className="font-display-lg text-lg font-bold text-dark mb-4">{form.title}</h3>
                <p className="font-ui-sm text-sm text-mid leading-relaxed mb-8">{form.desc}</p>
        ...
        <section className="bg-section-muted py-space-64">
          <div className="max-w-[1200px] mx-auto px-8 text-left">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="font-display-xl text-display-xl text-dark mb-6">Old vs New — compare using your actual books.</h2>
                <p className="font-ui-md text-ui-md text-mid leading-relaxed mb-8">
              ...
              <div className="bg-white border border-border-subtle p-8 shadow-sm">
                <div className="space-y-4 font-mono text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="font-ui text-mid">Total Tax</span>
                    <div className="flex gap-8">
        ...
        <section className="py-space-96 px-8 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="font-marketing-xl text-marketing-xl text-dark mb-6">File with confidence this year.</h2>
            <p className="font-ui-md text-ui-md text-mid mb-10">From P&L to ITR — zero re-entry. No double data entry, no audit anxiety.</p>
