    ...
    <div className="bg-page-bg text-dark antialiased min-h-screen">
      ...
      <main className="pt-32 pb-24">
        ...
        <header className="pt-space-128 pb-space-96 px-8 max-w-[1200px] mx-auto text-center">
          ...
          <p className="font-ui-lg text-ui-lg text-mid max-w-2xl mx-auto mb-12 leading-relaxed">
        ...
        <section className="py-space-96 px-8 bg-section-muted">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 text-left">
              ...
              <h2 className="font-display-xl text-display-xl text-dark mb-6">Auto-calculated statutory components.</h2>
              <p className="font-ui-md text-ui-md text-mid leading-relaxed mb-8">PF at 12% of basic. ESI at 0.75% for eligible employees. Professional Tax auto-set by state. TDS projection updated every month based on current deductions. No manual lookups.</p>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3">
                    ...
                    <span className="font-ui-sm text-sm text-mid">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            <div className="lg:col-span-7 bg-white border border-border-subtle p-8 shadow-sm">
              <div className="space-y-4 font-mono text-sm">
                <div className="flex justify-between py-2 border-b border-stone-50">
                  <span className="font-ui text-mid">Basic Salary</span>
                  <span className="font-bold">₹45,000.00</span>
                </div>
                <div className="flex justify-between py-2 border-b border-stone-50">
                  <span className="font-ui text-mid">HRA</span>
                  <span className="font-bold">₹18,000.00</span>
                </div>
                <div className="flex justify-between py-2 border-b border-stone-50">
                  <span className="font-ui text-mid">Conveyance Allowance</span>
                  <span className="font-bold">₹5,000.00</span>
                </div>
                <div className="flex justify-between py-2 border-b border-stone-50">
                  <span className="font-ui text-mid">Special Allowance</span>
        ...
        <section className="py-space-128 px-8">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="font-marketing-xl text-marketing-xl text-dark mb-4">A payslip that speaks human.</h2>
              <p className="font-ui-md text-ui-md text-mid max-w-2xl mx-auto leading-relaxed">Reduce payroll queries by 60% with detailed tax breakups and investment declarations baked right into the slip.</p>
            </div>
            <div className="bg-white border border-border-subtle p-12 max-w-4xl mx-auto shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <p className="font-ui-xs text-[10px] uppercase text-light font-bold mb-4">Earnings</p>
                  <div className="space-y-3">
                    {[{ label: "Basic", val: "45,000" }, { label: "HRA", val: "18,000" }, { label: "Conveyance", val: "5,000" }, { label: "Special Allowance", val: "12,000" }].map(e => (
                      <div key={e.label} className="flex justify-between text-sm">
                        <span className="text-mid">{e.label}</span>
                ...
                <div>
                  <p className="font-ui-xs text-[10px] uppercase text-light font-bold mb-4">Deductions</p>
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      <span className="text-mid">Provident Fund</span>
                      <span className="font-mono text-danger">-₹1,800</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-mid">Professional Tax</span>
                      <span className="font-mono text-danger">-₹200</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-mid">TDS</span>
        ...
        <section className="py-space-96 px-8 text-center bg-section-amber">
          <div className="max-w-2xl mx-auto">
            <h2 className="font-marketing-xl text-marketing-xl text-dark mb-6">Stop computing payroll manually.</h2>
            <p className="font-ui-md text-ui-md text-mid mb-10">Auto-calculated PF, ESI, PT, and TDS for every employee, every month.</p>
