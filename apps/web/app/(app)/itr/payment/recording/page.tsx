    ...
    <div className="space-y-0 text-left">
      ...
      <div className="max-w-5xl mx-auto pb-12">
        <div className="bg-white border-[0.5px] border-border-subtle shadow-sm relative overflow-hidden">
                ...
                {[
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className={`material-symbols-outlined text-[18px] ${type === item.id ? 'text-primary-container' : 'text-stone-300'}`}>
                        {type === item.id ? 'radio_button_checked' : 'radio_button_unchecked'}
                      </span>
                    </div>
          ...
          <span className="absolute -right-12 -bottom-12 material-symbols-outlined text-[200px] text-[#F4F2EE] opacity-30 pointer-events-none" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
        </div>
      </div>
    </div>
  );
