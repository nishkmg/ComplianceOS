  ...
  return (
    <div className="space-y-8 text-left">
      <header className="flex justify-between items-center px-8 py-6 border-b border-border-subtle bg-white/80 -mx-8 -mt-8 mb-8">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-mid uppercase tracking-widest mb-1">
            <Icon name="description" className="text-sm" /> Form 16 Data Export
          </div>
          <h1 className="font-display-lg text-lg font-bold text-dark">Employee Tax Report</h1>
          <p className="text-xs text-mid">Under Section 203 of the Income-tax Act, 1961</p>
        </div>
        <div className="flex gap-3">
          <select className="border border-border-subtle rounded-sm py-2 px-3 text-sm bg-section-muted">
      ...
      <div className="bg-white border border-border-subtle shadow-sm overflow-hidden">
        <div className="px-6 py-4 bg-section-muted border-b border-border-subtle">
          <h3 className="font-ui-md font-bold text-dark">Part A — TDS Deducted</h3>
        </div>
        <table className="w-full text-left border-collapse text-sm">
          <thead><tr className="border-b border-border-subtle bg-section-muted text-xs uppercase tracking-widest text-light font-bold">
          ...
          <tbody className="divide-y divide-stone-50 font-mono">
            <tr className="hover:bg-section-muted"><td className="px-6 py-4 font-ui-sm font-bold">Q1 (Apr-Jun)</td><td className="px-6 py-4 text-right">₹2,40,000</td><td className="px-6 py-4 text-right">₹18,000</td><td className="px-6 py-4 text-right text-success">✓</td></tr>
            <tr className="hover:bg-section-muted"><td className="px-6 py-4 font-ui-sm font-bold">Q2 (Jul-Sep)</td><td className="px-6 py-4 text-right">₹2,40,000</td><td className="px-6 py-4 text-right">₹18,000</td><td className="px-6 py-4 text-right text-success">✓</td></tr>
          </tbody>
        </table>
      </div>
    </div>
