  ...
  return (
    <div className="space-y-8 text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border border-border p-6 bg-surface shadow-sm">
        <div><span className="block text-ui-2xs uppercase text-light font-bold mb-1">Name of the Employer</span><p className="font-bold text-dark text-lg">Arthvahi Solutions Pvt Ltd</p></div>
        <div className="text-right"><span className="block text-ui-2xs uppercase text-light font-bold mb-1">PAN of Employer</span><span className="font-mono text-sm font-bold">AAACC1234E</span></div>
      </div>
      ...
      <div className="border border-border p-6 bg-surface shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 border-t border-border pt-4">
          <div><span className="block text-ui-2xs uppercase text-light font-bold mb-1">PAN</span><span className="font-mono text-sm">ABCDE1234F</span></div>
          <div><span className="block text-ui-2xs uppercase text-light font-bold mb-1">Employee Ref</span><span className="font-mono text-sm">EMP-2021-042</span></div>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border shadow-sm overflow-hidden">
        ...
        <table className="w-full text-left border-collapse text-sm">
          ...
          <tbody className="divide-y 50-border font-mono">
            <tr className="hover:bg-surface-muted"><td className="px-6 py-4 font-ui text-ui-sm font-bold">Q1 (Apr-Jun)</td><td className="px-6 py-4 text-right">₹2,40,000</td><td className="px-6 py-4 text-right">₹18,000</td><td className="px-6 py-4 text-right text-success">✓</td></tr>
            <tr className="hover:bg-surface-muted"><td className="px-6 py-4 font-ui text-ui-sm font-bold">Q2 (Jul-Sep)</td><td className="px-6 py-4 text-right">₹2,40,000</td><td className="px-6 py-4 text-right">₹18,000</td><td className="px-6 py-4 text-right text-success">✓</td></tr>
          </tbody>
        </table>
      </div>
    </div>
