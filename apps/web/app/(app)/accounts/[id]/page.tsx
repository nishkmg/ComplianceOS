      ...
      <div className="bg-surface border border-border rounded-md shadow-sm overflow-hidden">
        ...
        <table className="w-full text-left border-collapse">
          <thead><tr className="bg-surface-muted border-b border-border">
            ...
            <th className="py-3 px-6 font-ui text-ui-2xs text-light uppercase tracking-widest">Entry</th>
          ...
          <tbody className="divide-y divide-border-subtle">
            {transactions.length === 0 ? (
              ...
              <tr key={t.id || i} className="hover:bg-surface-muted transition-colors">
                ...
                <td className="py-3 px-6 font-mono text-ui-xs text-amber">{t.entryNumber || "—"}</td>
