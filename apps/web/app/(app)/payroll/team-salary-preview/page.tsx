    ...
    <div className="space-y-6 text-left">
      <div className="flex justify-between items-end gap-4 border-b border-border pb-6 mb-8">
        <div>
          ...
          <p className="text-ui-sm text-secondary font-ui mt-1">Review individual employee compensation details for October 2023 before final authorization.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 border border-border bg-surface rounded-md overflow-hidden shadow-sm mb-8">
        <div className="p-6 border-r border-border"><div className="font-ui text-ui-2xs text-light mb-1 font-bold uppercase">Total Employees</div><div className="font-mono text-xl font-bold text-dark">142</div></div>
        <div className="p-6 border-r border-border bg-amber-50"><div className="font-ui text-ui-2xs text-light mb-1 font-bold uppercase">Total Gross</div><div className="font-mono text-xl font-bold text-dark">₹ 42,50,000.00</div></div>
        <div className="p-6 border-r border-border"><div className="font-ui text-ui-2xs text-light mb-1 font-bold uppercase">Total Deductions</div><div className="font-mono text-xl font-bold text-mid">₹ 4,85,200.00</div></div>
        <div className="p-6 bg-surface-muted border-t-2 border-t-amber"><div className="font-ui text-ui-2xs text-light mb-1 font-bold uppercase">Net Payable</div><div className="font-mono text-xl font-bold text-primary">₹ 37,64,800.00</div></div>
      </div>
      <div className="bg-surface border border-border shadow-sm overflow-hidden">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y 50-border font-mono text-sm">
            <tr className="hover:bg-surface-muted"><td className="px-6 py-4"><span className="font-ui text-ui-sm font-bold">Rahul Sharma</span><span className="text-xs text-light ml-2">EMP-001</span></td>
