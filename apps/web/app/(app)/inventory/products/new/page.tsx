    ...
    <div className="bg-page-bg text-dark page-bg min-h-screen flex text-left">
      <main className="flex-1 ml-0 pb-16">
        ...
        <div className="flex justify-between items-end border-b-[0.5px] border-border-subtle px-8 py-6 mb-10 sticky top-0 z-20 bg-white/80 backdrop-blur-md">
          <div>
            <div className="flex items-center gap-2 font-ui-xs text-[10px] text-mid mb-2 uppercase tracking-widest">
            ...
            <h2 className="font-display-xl text-3xl text-dark font-bold">Add New Product</h2>
            <p className="font-ui-md text-sm text-mid mt-2 max-w-2xl">Enter product details for compliance tracking and inventory valuation.</p>
          </div>
          <div className="flex items-center gap-4">
            <button onClick={() => router.back()} className="font-ui-sm text-xs text-mid hover:text-dark transition-colors border-none bg-transparent cursor-pointer font-bold uppercase tracking-widest">Cancel</button>
          ...
          <form className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-8">
              <div className="bg-white border border-border-subtle p-8 shadow-sm">
                ...
                <h3 className="font-ui-lg text-lg font-bold text-dark mb-6 uppercase tracking-wider text-[11px] text-light">Product Information</h3>
                <div className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col gap-2">
                      <label className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold">SKU Code</label>
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold">HSN / SAC Code</label>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold">Product Name</label>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold">Category</label>
              ...
              <div className="bg-white border border-border-subtle p-8 shadow-sm">
                <h3 className="font-ui-lg text-lg font-bold text-dark mb-6 uppercase tracking-wider text-[11px] text-light">Valuation & Tax Configuration</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="flex flex-col gap-2">
                    <label className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold">Unit</label>
                    <div className="relative">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold">Opening Stock</label>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-ui-xs text-[10px] text-light uppercase tracking-widest font-bold">Unit Price (₹)</label>
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="bg-white border border-border-subtle p-8 shadow-sm border-t-2 border-t-primary-container">
                <h3 className="font-ui-sm text-xs font-bold uppercase tracking-widest text-light mb-6">Tax Defaults</h3>
                <div className="flex flex-col gap-2">
                  <label className="font-ui-xs text-[10px] text-mid uppercase tracking-widest font-bold">Default GST Rate</label>
                  <div className="relative">
                    <select className="w-full bg-section-muted border border-border-subtle rounded-sm px-4 py-3 font-ui-sm text-sm outline-none focus:border-primary appearance-none" value={formData.gstRate} onChange={e => setFormData({...formData, gstRate: parseInt(e.target.value)})}>
              ...
              <div className="bg-section-dark text-white p-8 shadow-sm border-t-2 border-t-primary-container">
                <h3 className="font-ui-sm text-xs font-bold uppercase tracking-widest text-light mb-6">Compliance Status</h3>
