...
export default function FiscalYearDetailPage() {
  ...
  return (
    <div className="space-y-6 text-left">
      {/* Breadcrumbs */}
      <div className="flex items-center gap-2 font-ui-xs text-[10px] text-light uppercase tracking-widest mb-12">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 border-b-[0.5px] border-border-subtle pb-8">
        <div className="text-left">
          <div className="flex items-center gap-4 mb-3">
            <h1 className="font-display-xl text-4xl text-dark tracking-tight">FY 2024-25</h1>
            <span className="font-ui-xs text-[10px] uppercase tracking-widest text-amber-text border border-primary-container px-3 py-1 bg-section-amber rounded-sm font-bold">Open</span>
          </div>
          <p className="font-ui-md text-ui-md text-mid">Reporting period: April 1, 2024 — March 31, 2025</p>
        </div>
        <div className="flex gap-4">
          <button className="flex items-center gap-2 border border-border-subtle px-5 py-2.5 font-ui-sm text-xs font-bold uppercase tracking-widest hover:bg-surface-container-highest transition-colors cursor-pointer bg-transparent">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
        <div className="bg-white border border-border-subtle p-8 border-t-2 border-t-primary-container shadow-sm hover:shadow-md transition-shadow text-left">
          ...
          <div className="font-ui-sm text-xs text-light flex items-center gap-1">
            <Icon name="trending_up" className="text-[14px] text-success" />
            <span className="text-success font-bold">+4.2%</span> vs previous year
          </div>
        </div>

        <div className="bg-white border border-border-subtle p-8 shadow-sm hover:shadow-md transition-shadow text-left">
          <div className="flex justify-between items-start mb-6 text-light">
          ...
          <div className="font-ui-sm text-xs text-light">
        ...
        <div className="bg-white border border-border-subtle p-8 shadow-sm hover:shadow-md transition-shadow text-left">
          ...
          <div className="font-ui-sm text-xs text-light uppercase tracking-widest font-bold">
      ...
      <section className="border-t-[0.5px] border-border-subtle pt-16 text-left">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
          <div className="md:col-span-5">
            <h2 className="font-display-xl text-3xl text-dark mb-6 font-bold">Year-End Finalization</h2>
            <p className="font-ui-md text-sm text-mid leading-relaxed mb-6">
            ...
            <div className="bg-section-amber border border-amber/30 p-6 rounded-sm">
          ...
          <div className="md:col-span-7 flex flex-col justify-center items-end">
            <button className="bg-stone-100 border border-border-subtle text-mid px-12 py-4 font-ui-sm font-bold uppercase tracking-widest cursor-not-allowed opacity-50">
              Close Fiscal Year
            </button>
