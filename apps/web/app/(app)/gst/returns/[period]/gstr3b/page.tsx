  ...
  return (
    <div className="max-w-[1200px] mx-auto space-y-8 pb-40">
      <div className="flex items-center gap-4">
        ...
        <div><h1 className="font-display text-display-lg font-semibold text-dark">GSTR-3B</h1><p className="font-ui text-[13px] text-text-mid mt-1">Monthly Summary Return — {month}/{fy}</p></div>
      </div>
