  ...
  return (
    <div className="max-w-page mx-auto space-y-8 pb-40">
      <div className="flex items-center gap-4">
        ...
        <div><h1 className="font-ui text-display-lg font-semibold text-dark">GSTR-2B</h1><p className="font-ui text-ui-sm text-text-mid mt-1">Inward Supply Details — {month}/{fy}</p></div>
      </div>
