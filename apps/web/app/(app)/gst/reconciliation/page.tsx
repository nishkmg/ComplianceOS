    ...
    <div className="space-y-0 text-left">
      ...
      <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-[0.5px] border-border pb-8">
        ...
        <div className="flex gap-3">
          <button className="px-5 py-2 border border-border text-dark font-ui text-[13px] rounded-md hover:bg-surface-muted transition-colors flex items-center gap-2 cursor-pointer bg-transparent uppercase tracking-widest font-bold">
            Fetch Latest 2B
          </button>
          <button className="bg-amber text-white px-8 py-2.5 rounded-md font-ui text-[13px] hover:bg-amber-hover transition-colors cursor-pointer border-none shadow-sm font-bold uppercase tracking-widest">
            Run Auto-Match
          </button>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border shadow-sm overflow-hidden">
        <div className="bg-surface-muted border-b-[0.5px] border-border flex p-2 gap-2 no-print">
          <button className="px-4 py-1.5 bg-surface border border-border rounded-md text-[11px] uppercase tracking-widest font-bold text-dark cursor-pointer">All Invoices</button>
          <button className="px-4 py-1.5 hover:bg-surface-muted transition-colors rounded-md text-[11px] uppercase tracking-widest font-bold text-mid cursor-pointer border-none bg-transparent">Mismatch (12)</button>
          <button className="px-4 py-1.5 hover:bg-surface-muted transition-colors rounded-md text-[11px] uppercase tracking-widest font-bold text-mid cursor-pointer border-none bg-transparent">Reconciled</button>
        </div>
