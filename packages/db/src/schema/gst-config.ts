import {
  pgTable, uuid, text, numeric, boolean, jsonb, timestamp,
  uniqueIndex, index,
...
export const gstrTableMappings = pgTable("gstr_table_mappings", {
  ...
  uniqueIndex("gstr_table_mappings_tenant_return_table_unique").on(
    table.tenantId, table.returnType, table.tableNumber
  ),
