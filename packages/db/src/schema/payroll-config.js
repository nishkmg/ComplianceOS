import { pgTable, uuid, text, numeric, date, timestamp, jsonb, boolean, uniqueIndex, index, } from "drizzle-orm/pg-core";
...
export const payrollSummary = pgTable("payroll_summary", {
    ...
    uniqueIndex("payroll_summary_tenant_employee_month_year_unique").on(table.tenantId, table.employeeId, table.month, table.year),
...
export const statutoryLiabilities = pgTable("statutory_liabilities", {
    ...
    uniqueIndex("statutory_liabilities_tenant_month_year_unique").on(table.tenantId, table.month, table.year),
]);
