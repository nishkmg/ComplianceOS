import { pgTable, uuid, text, numeric, date, timestamp, boolean, integer, uniqueIndex, index, } from "drizzle-orm/pg-core";
...
export const salaryComponents = pgTable("salary_components", {
    ...
    uniqueIndex("salary_components_tenant_id_component_code_unique").on(table.tenantId, table.componentCode),
...
export const employeeSalaryStructures = pgTable("employee_salary_structures", {
    ...
    uniqueIndex("employee_salary_structures_tenant_employee_component_version_unique").on(table.tenantId, table.employeeId, table.componentId, table.version),
