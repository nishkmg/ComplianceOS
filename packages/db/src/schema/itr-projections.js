import { pgTable, uuid, text, numeric, timestamp, bigint, uniqueIndex, index, } from "drizzle-orm/pg-core";
export const itrAnnualIncomeProjection = pgTable("itr_annual_income_projection", {
    ...
    uniqueIndex("itr_annual_income_projection_tenant_fy_unique").on(table.tenantId, table.financialYear),
...
export const itrTaxSummaryProjection = pgTable("itr_tax_summary_projection", {
    ...
    uniqueIndex("itr_tax_summary_projection_tenant_ay_unique").on(table.tenantId, table.assessmentYear),
...
export const itrAdvanceTaxProjection = pgTable("itr_advance_tax_projection", {
    ...
    uniqueIndex("itr_advance_tax_projection_tenant_ay_unique").on(table.tenantId, table.assessmentYear),
