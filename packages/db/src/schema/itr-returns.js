import { pgTable, uuid, text, numeric, timestamp, jsonb, uniqueIndex, index, } from "drizzle-orm/pg-core";
...
export const itrReturns = pgTable("itr_returns", {
    ...
    uniqueIndex("itr_returns_tenant_ay_fy_type_unique").on(table.tenantId, table.assessmentYear, table.financialYear, table.returnType),
