...
export const referenceTypeEnum = pgEnum("reference_type", [
  "invoice", "payment", "receipt", "journal", "payroll", "inventory", "opening_balance", "credit_note", "purchase_bill", "manual",
]);
...
export const aggregateTypeEnum = pgEnum("aggregate_type", [
  ...
  "gst_challan", "gst_payment", "gst_return", "itr_return", "purchase_bill",
]);
...
export const eventTypeEnum = pgEnum("event_type", [
  ...
  "purchase_posted", "purchase_voided", "itc_reversed", "gst_refund_claimed", "gstr1_generated", "gstr2b_generated", "gstr3b_generated", "gstr9_generated",
  "purchase_bill_created", "purchase_bill_paid",
  "income_computed", "tax_computed", "itr_generated",
  "itr_return_created", "itr_return_generated", "itr_return_amended", "itr_return_filed", "itr_return_voided",
  "itr_pdf_generated",
  "invoice_irn_generated", "ewaybill_generated", "advance_tax_paid", "advance_cancelled",
  "self_assessment_tax_paid", "payment_allocated", "gst_return_filed", "gst_return_amended", "itr_filed", "itr_voided",
]);
...
export const gstTaxTypeEnum = pgEnum("gst_tax_type", ["igst", "cgst", "sgst", "cess", "interest", "penalty"]);
